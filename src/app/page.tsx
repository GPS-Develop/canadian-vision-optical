    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="w-full bg-gray-50 py-16 px-4 flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col md:flex-row gap-10 w-full max-w-5xl items-center justify-center">
          {/* Map */}
          <AnimationWrapper className="w-full md:w-1/2" delay={0.1}>
            <div className="w-full h-[300px] rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              <iframe
          ...
          {/* Store Info */}
          <AnimationWrapper className="w-full md:w-1/2" delay={0.2}>
